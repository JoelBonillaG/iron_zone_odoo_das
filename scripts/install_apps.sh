...
MODULES="${MODULES:-website,website_sale,website_sale_stock,account,hr,mass_mailing,appointment,sale_management,stock,iz_website,iz_inventory,iz_backend_theme,event}"
