...
class SaleSubscriptionLine(models.Model):
    ...
    _description = "Lineas de suscripcion"
    ...
    name = fields.Char(
        string="Descripcion", compute="_compute_name", store=True, readonly=False
    )
    product_uom_qty = fields.Float(default=1.0, string="Cantidad")
    price_unit = fields.Float(
        string="Precio unitario", compute="_compute_price_unit", store=True, readonly=False
    )
    discount = fields.Float(
        string="Descuento (%)", compute="_compute_discount", store=True, readonly=False
    )
    ...
    amount_tax_line_amount = fields.Float(
        string="Valor de impuestos", compute="_compute_subtotal", store=True
    )
