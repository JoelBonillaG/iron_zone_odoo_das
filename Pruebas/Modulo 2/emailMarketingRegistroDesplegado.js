...
import { DEPLOYED_BASE_URL } from "./testHelpers.js";
...
const BASE_URL = DEPLOYED_BASE_URL;
...
runFlow("email marketing registro y eventos desplegado", async (page) => {
  ...
  const welcomeMails = await waitForMail(page, [["email_to", "ilike", NEW_USER.email], ["subject", "ilike", "Bienvenido"]], { limit: 1, order: "create_date desc" });
  await openMarketingMailAndClaim(page, { mailIds: welcomeMails, screenshotName: "3_correo_bienvenida", logMessage: "Mostrando correo bienvenida...", claimLabel: "Reclamando regalo...", sectionTitle: "Correo de bienvenida", sectionSubtitle: "El socio recibe un beneficio especial por su registro y cumpleaños.", sectionBadge: "Bienvenida + Cumpleaños" });
  ...
  await openMarketingMailAndClaim(page, { mailIds: goalMails, screenshotName: "5_correo_fitness", logMessage: "Mostrando correo Bienestar...", claimLabel: "Reservando clase...", sectionTitle: "Campaña de Bienestar", sectionSubtitle: "Se ofrece un descuento para Yoga basado en su objetivo fitness.", sectionBadge: "Salud Integral" });
  ...
  await openMarketingMailAndClaim(page, { mailIds: womanMails, screenshotName: "7_correo_mujer", logMessage: "Mostrando correo Mujer...", claimLabel: "Reclamando evento gratis...", sectionTitle: "Campaña Día de la Mujer", sectionSubtitle: "La socia accede a un evento premium gratuito exclusivo.", sectionBadge: "Evento Gratis" });
